Template.documents_create.events({
  'submit form': function(e){
    ...
    var uploadCount = document.getElementById('uploadImage').files.length;
    ...
    oFReader.onload =  function(fEvent){
      ...
      Documents.update({_id: _id},{$push: {encodedImg: fEvent.target.result, canvas: ''}});
      uploadCount--;
      if(uploadCount===0){ $('.complete').removeClass('hidden')}
    }
